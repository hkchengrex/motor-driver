...
#define ACTIVATE_HIGH_LIMIT_SWITCH	true
#define ACTIVATE_LOW_LIMIT_SWITCH		true
...
// -1 if the pwm direction is different from the encoder direction
#define PWM_DIRCETION (1)
